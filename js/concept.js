...
const ART_MEDIUMS = [
  ...
  // Digital
  { name: 'Procreate (Digital)', category: 'Digital', brushShape: 'Any (customisable)', wetDry: 'N/A', stickability: 'N/A — infinite paint', irregularity: 'Configurable', valueThickness: 'Fully pressure-sensitive', naturalSize: 'Any size', colourMode: 'Full colour', sizeDiff: 'Configurable', smergability: 'Configurable via Wet Mix' },
  { name: 'Photoshop (Digital)', category: 'Digital', brushShape: 'Any', wetDry: 'N/A', stickability: 'N/A', irregularity: 'Configurable', valueThickness: 'Pressure-sensitive', naturalSize: 'Any size', colourMode: 'Full colour', sizeDiff: 'Configurable', smergability: 'Smudge tool available' },
  { name: 'Clip Studio Paint (Digital)', category: 'Digital', brushShape: 'Any', wetDry: 'N/A', stickability: 'N/A', irregularity: 'Configurable', valueThickness: 'Pressure-sensitive', naturalSize: 'Any size', colourMode: 'Full colour', sizeDiff: 'Configurable', smergability: 'Configurable' },
];
